dataset_to_paths = {
    "camvid": {
        "dir_imgs": "../../../data/CamVid/train",  # Directory containing the images
        "dir_gts": "../../../data/CamVid/trainannot",  # Directory containing the groundtruth labels
...
if __name__ == '__main__':
    ...
    from pixelpick.annotation_tool.utils.utils import *
    ...
    os.makedirs(dir_log+"/train", exist_ok=True)
    ...
    for i, index in tbar:
        ...
        for ind in range(len(loc_points)):
            ...
            logger(fname, f"{loc_points[ind]},{label_category[alphabet_l.index(label)].lower()},{delta},{total_time}\n", 'a')
